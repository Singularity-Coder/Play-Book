...
public class MusicForegroundService extends Service implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener {
    ...
    public void onCreate() {
        ...
        initPlayer();
        currentTrack = null;
        registerReceiver(buttonClicksReceiver, new IntentFilter(Constants.BUTTONS_BROADCAST_INTENT_KEY), Context.RECEIVER_NOT_EXPORTED);
    }
    ...
    public void createNotificationLayout() {
        ...
        PendingIntent rewindClickedPIntent = PendingIntent.getBroadcast(this, Constants.REWIND_INTENT_REQUEST_CODE, rewindClickedIntent, PendingIntent.FLAG_IMMUTABLE);
        ...
        PendingIntent playPauseClickedPIntent = PendingIntent.getBroadcast(this, Constants.PLAY_PAUSE_INTENT_REQUEST_CODE, playPauseClickedIntent, android.app.PendingIntent.FLAG_IMMUTABLE);
        ...
        PendingIntent forwardClickedPIntent = PendingIntent.getBroadcast(this, Constants.FORWARD_INTENT_REQUEST_CODE, forwardClickedIntent, PendingIntent.FLAG_IMMUTABLE);
        ...
        PendingIntent closeClickedPIntent = PendingIntent.getBroadcast(this, Constants.CLOSE_INTENT_REQUEST_CODE, closeClickedIntent, android.app.PendingIntent.FLAG_IMMUTABLE);
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        if (currentTrack != null) {
            ...
            if (autoPlayNext) {
                int trackIndex = 0;
                if (currentTrack != null) {
                    trackIndex = trackList.indexOf(currentTrack);
                }
