...
public class MainActivity extends AppCompatActivity implements TrackListAdapter.OnTrackListItemClickListener, TrackListAdapter.MusicPlayer, View.OnClickListener {
    ...
    private void performInits() {
        ...
        // ViewModelProvider.Factory.from(MusicPlayerViewModelFactory.)
        viewModel = new ViewModelProvider(
                this,
                androidx.lifecycle.ViewModelProvider.Factory.from(MusicPlayerViewModel.initializer)
    ...
    public void onClick(View v) {
        int viewID = v.getId();
        if (viewID == R.id.ib_play_pause) {
            playPauseButtonClick();
        } else if (viewID == R.id.ib_forward) {
            forwardButtonClick();
        } else if (viewID == R.id.ib_rewind) {
            rewindButtonClick();
        }
    }
